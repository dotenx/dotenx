...
(function (content_v2_1) {
    ...
    class Content {
        constructor(options, google) {
            ...
            this.accountsbyexternalsellerid = new Resource$Accountsbyexternalsellerid(this.context);
    ...
    class Resource$Accountsbyexternalsellerid {
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/content/v2.1/{merchantId}/accountsbyexternalsellerid/{externalSellerId}').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                }, options),
                params,
    ...
    content_v2_1.Resource$Accountsbyexternalsellerid = Resource$Accountsbyexternalsellerid;
