...
import imageUrl from '../../assets/components/gallery-masonry-1.png'
...
export class GalleryMasonaryOne extends Component {
	name = 'Masonry Gallery 1'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(options: ElementOptions): ReactNode {
		return <GalleryMasonaryOneOptions />
	}
}
...
function GalleryMasonaryOneOptions() {
...
const insertTab = () => img('https://files.dotenx.com/assets/random-10-b01.jpg')
