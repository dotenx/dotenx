...
import imageUrl from '../../assets/components/feature-details-grid-image-tag-left.png'
...
export class FeatureDetailsGridImageTagLeft extends Component {
	name = 'Features with details on left and tagged grid'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(options: ElementOptions): ReactNode {
		return <FeatureDetailsGridImageTagLeftOptions />
	}
}

// =============  renderOptions =============

function FeatureDetailsGridImageTagLeftOptions() {
	...
	return (
		<ComponentWrapper name="Features with details on left and tagged grid">
