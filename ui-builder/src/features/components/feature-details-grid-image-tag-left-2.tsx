...
import imageUrl from '../../assets/components/feature-details-grid-image-tag-left-2.png'
...
export class FeatureDetailsGridImageTagLeft2 extends Component {
	name = 'Features with details on left and tagged grid - 2'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(options: ElementOptions): ReactNode {
		return <FeatureDetailsGridImageTagLeft2Options />
	}
}

// =============  renderOptions =============

function FeatureDetailsGridImageTagLeft2Options() {
	const component = useSelectedElement<BoxElement>()!
	const grid = component.find<ColumnsElement>(tagIds.grid)!
	const image = component.find<ImageElement>(tagIds.image)!

	return (
		<ComponentWrapper name="Features with details on left and tagged grid - 2">
