import componentImage from '../../../assets/components/features/feature-8.png'
...
export class Feature8 extends Component {
	name = 'Feature 8'
...
function Options() {
	...
	return (
		<ComponentWrapper name="Feature 8">
			<BackgroundImageEditor element={component} />
