...
import imageUrl from '../../assets/components/about-left-5.png'
...
export class AboutLeft5 extends Component {
	name = 'About us with details on the left - 5'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(): ReactNode {
		return <AboutLeft5Options />
	}
}

// =============  renderOptions =============

function AboutLeft5Options() {
	...
	return (
		<ComponentWrapper name="About us with details on the left - 5">
