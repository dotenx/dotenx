...
import imageUrl from '../../assets/components/about-right-4.png'
...
export class AboutRight4 extends Component {
	name = 'About us with details on the right - 4'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(): ReactNode {
		return <AboutRight4Options />
	}
}

// =============  renderOptions =============

function AboutRight4Options() {
	...
	return (
		<ComponentWrapper name="About us with details on the right - 4">
