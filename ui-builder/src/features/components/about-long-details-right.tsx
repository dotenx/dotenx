...
import imageUrl from '../../assets/components/about-long-details-right.png'
...
export class AboutLongDetailsRight extends Component {
	name = 'About us with long details on the right'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(): ReactNode {
		return <AboutLongDetailsRightOptions />
	}
}

// =============  renderOptions =============

function AboutLongDetailsRightOptions() {
	...
	return (
		<ComponentWrapper name="About us with long details on the right">
