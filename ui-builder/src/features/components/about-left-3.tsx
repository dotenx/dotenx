...
import imageUrl from '../../assets/components/about-left-3.png'
...
export class AboutLeft3 extends Component {
	name = 'About us with details on the left - 3'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(): ReactNode {
		return <AboutLeft3Options />
	}
}

// =============  renderOptions =============

function AboutLeft3Options() {
	...
	return (
		<ComponentWrapper name="About us with details on the left - 3">
