...
import imageUrl from '../../assets/components/footer-simple-links-on-right.png'
...
export class FooterSimpleWithLinksOnRight extends Component {
	name = 'Simple footer with links on right'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(options: ElementOptions): ReactNode {
		return <FooterSimpleWithLinksOnRightOptions options={options} />
	}
}

// =============  renderOptions =============

function FooterSimpleWithLinksOnRightOptions({ options }: { options: ElementOptions }) {
	...
	return (
		<ComponentWrapper name="Simple footer with links on right">
