...
export class HeroWithBgTwoCta extends Component {
	name = 'Hero with background image and two CTAs'
	image = imageUrl
	defaultData = deserializeElement(defaultData)
	renderOptions = () => <HeroWithBgTwoCtaOptions />
}

// =============  renderOptions =============

function HeroWithBgTwoCtaOptions() {
	...
	return (
		<ComponentWrapper name="Hero with background image and two CTAs">
