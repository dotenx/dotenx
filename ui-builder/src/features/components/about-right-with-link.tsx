...
import imageUrl from '../../assets/components/about-right-with-link.png'
...
export class AboutRightWithLink extends Component {
	name = 'About us with details and link on the right'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(): ReactNode {
		return <AboutRightWithLinkOptions />
	}
}

// =============  renderOptions =============

function AboutRightWithLinkOptions() {
	...
	return (
		<ComponentWrapper name="About us with details and link on the right">
