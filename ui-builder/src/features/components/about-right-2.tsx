...
import imageUrl from '../../assets/components/about-right-2.png'
...
export class AboutRight2 extends Component {
	name = 'About us with details on the right - 2'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(): ReactNode {
		return <AboutRight2Options />
	}
}

// =============  renderOptions =============

function AboutRight2Options() {
	...
	return (
		<ComponentWrapper name="About us with details on the right - 2">
