...
import imageUrl from '../../assets/components/about-video-stats-right.png'
...
export class AboutVideoStatsRight extends Component {
	name = 'About us with video one the right and stats'
	image = imageUrl
	defaultData = deserializeElement(defaultData)

	renderOptions(): ReactNode {
		return <AboutVideoStatsRightOptions />
	}
}

// =============  renderOptions =============

function AboutVideoStatsRightOptions() {
	...
	return (
		<ComponentWrapper name="About us with video one the right and stats">
...
const defaultData = {
	...frame,
	components: [statsSideWrapper, videoSideWrapper],
}
