// image: dotenx/task-and-trigger:open-ai-create-instagram-post-lambda
package main
...
func HandleLambdaEvent(event Event) (Response, error) {
	...
	prompt := fmt.Sprintf("Write an Instagram post about the following content:\n%s\nThis post should be written based on SEO techniques and should be about these keywords: %s", explanation, keywords)
