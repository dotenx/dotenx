// image: dotenx/task-and-trigger:open-ai-create-facebook-blog-post-lambda
package main
...
func HandleLambdaEvent(event Event) (Response, error) {
	...
	prompt := fmt.Sprintf("Write a blog post for Facebook Blog about the following content:\n%s\nThis blog post should be written based on SEO techniques and should be about these keywords: %s", explanation, keywords)
