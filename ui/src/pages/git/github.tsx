...
import { TbFileImport, TbTableExport } from "react-icons/tb"
...
const GithubIntegration = ({ resetProvider }: { resetProvider: () => void }) => {
	...
	return (
		<div className="mx-auto mt-10 bg-white rounded-md p-5 w-2/3">
			<Select
				radius={"md"}
							...
							{repoList.map((repoName) => (
								...
								>
									...
									<div className="flex items-center gap-x-5">
										<Button
											rightIcon={<TbTableExport className="w-5 h-5" />}
											onClick={() => {
