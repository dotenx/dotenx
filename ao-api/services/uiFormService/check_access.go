...
func (uf *uiFormService) CheckAddFormResponseAccess(accountId, projectType string) (bool, error) {
	dto := checkAccessDto{
		AccountId:   accountId,
	...
	url := config.Configs.Endpoints.Admin + "/internal/user/access/formResponses"
