...
See https://github.com/dotenx/dotenx/ao-api/oauth/dotenx_goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/dotenx/dotenx/ao-api/oauth/dotenx_goth/examples/main.go to see this in action.
*/
