...
type PipelineStore interface {
	...
	Create(context context.Context, base *models.Pipeline, pipeline *models.PipelineVersion, isTemplate bool) error // todo: return the endpoint
	...
	GetByName(context context.Context, accountId string, name string) (pipeline models.PipelineVersion, endpoint string, isActive bool, isTemplate bool, err error)
